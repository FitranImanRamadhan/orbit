            ...
            <div class="modal-content border-0 shadow-lg rounded-3">
                ...
                <div class="modal-body bg-light">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control shadow-sm" id="keterangan" rows="3" placeholder="Isi keterangan hardware..."></textarea>
                    </div>
            ...
            $.ajax({
                ...
                success: function(res) {
                    if (res.success) {
                        ...
                        // validasi gagal atau server kirim res.success = false
                        Swal.fire({
                            icon: 'warning',
                            title: 'Gagal',
                ...
                error: function(xhr) {
                    let message = (xhr.responseJSON && xhr.responseJSON.message) || 'Proses gagal';
                    Swal.fire({
                        icon: 'error',
                        title: 'Gagal',
                        text: message
