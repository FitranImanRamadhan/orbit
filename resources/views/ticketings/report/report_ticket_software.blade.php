...
function applyFilter() {
    ...
    $.ajax({
        url: '/ticketings/report/data_report_ticket_software',
        type: 'POST',
        data: {
            year: year,
            month: month,
...
function openChart() {
    ...
    if (!year || !month || !week) {
        Swal.fire('Perhatian', 'Pilih filter dulu', 'warning');
        return;
    }

    let url = `/ticketings/report/chart_ticket_software?year=${year}&month=${month}&week=${week}`;
